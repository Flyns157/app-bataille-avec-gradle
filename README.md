...
```
cd existing_repo
git remote add origin https://gitlab.univ-artois.fr/matteo_cuisset/app-bataille-avec-gradle.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.univ-artois.fr/matteo_cuisset/app-bataille-avec-gradle/-/settings/integrations)
